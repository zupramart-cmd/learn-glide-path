...
const FAQS: FAQ[] = [
  {
    ...
    answer:
      "ব্রাউজারে অ্যাপটি ওপেন করলে উপরে **Install** বাটন দেখা যাবে — সেখানে ক্লিক করে ইন্সটল করুন। সোশ্যাল মিডিয়া থেকে ওপেন করলে স্বয়ংক্রিয়ভাবে ব্রাউজারে রিডাইরেক্ট হয়ে যাবে। 📲",
  ...
  },
  {
    ...
    answer:
      "মাত্র **১টি ডিভাইসে**। একাধিক ডিভাইসে চেষ্টা করলে অ্যাকাউন্ট **ডিসেবল/টার্মিনেট** হয়ে যাবে। 🔒",
    keywords: ["ডিভাইস", "device", "লগইন", "login", "একাউন্ট", "account", "কয়টি", "কতগুলো"],
  },
  {
    id: "tech",
    icon: <ShieldQuestion className="h-3.5 w-3.5" />,
    question: "টেকনিক্যাল সমস্যা হলে কী করব?",
    answer:
      "সরাসরি ডেভেলপারের সাথে WhatsApp-এ যোগাযোগ করুন: https://wa.me/8801712525910 💬",
    keywords: ["সমস্যা", "problem", "issue", "bug", "কাজ করছে না", "error", "টেকনিক্যাল", "technical"],
  },
  {
    id: "enroll",
    icon: <UserPlus className="h-3.5 w-3.5" />,
    question: "কোর্সে কিভাবে এনরোল করব?",
    answer:
      "কোর্স পেজ থেকে পছন্দের কোর্সে **বিস্তারিত** বাটনে ক্লিক করুন, নিচে **Enroll** অপশন পাবেন, তথ্য পূরণ করে এনরোল রিকোয়েস্ট পাঠান। ✅",
    keywords: ["এনরোল", "enroll", "ভর্তি", "যুক্ত", "join", "admission", "কোর্স"],
  },
  {
    id: "payment",
    ...
    answer:
      "রেজিস্ট্রেশন পেজে পেমেন্ট অপশন থেকে নম্বর কপি করে **Send Money** করুন, তারপর আপনার পেমেন্ট নম্বর ও **Transaction ID** নির্ভুলভাবে বসান। 💳",
    keywords: ["পেমেন্ট", "payment", "টাকা", "বিকাশ", "bkash", "নগদ", "nagad", "send money", "টাকা দিব"],
  },
  {
    id: "group",
    icon: <Phone className="h-3.5 w-3.5" />,
    question: "কোর্সের গ্রুপে কিভাবে যুক্ত হব?",
    answer:
      "প্রোফাইল পেজ বা সাইডবারে **Discussion Group** অপশন থেকে যুক্ত হওয়া যাবে। 👥",
    keywords: ["গ্রুপ", "group", "ডিসকাশন", "discussion", "যুক্ত", "join"],
  },
  {
    id: "class",
    icon: <PlayCircle className="h-3.5 w-3.5" />,
    question: "ক্লাস কিভাবে করব?",
    answer:
      "এনরোল হলে অ্যাপের **Content** পেজে সব ক্লাস সুন্দরভাবে সাজানো অবস্থায় পাওয়া যাবে। 🎬",
    keywords: ["ক্লাস", "class", "ভিডিও", "video", "lecture", "কন্টেন্ট", "content"],
  },
  {
    id: "pdf",
    icon: <ClipboardList className="h-3.5 w-3.5" />,
    question: "ক্লাসের PDF কোথায় পাব?",
    answer:
      "প্রতিটি ভিডিও প্লেয়ারের নিচে সেই ক্লাসের PDF পাওয়া যাবে। এছাড়া প্রোফাইল পেজ বা সাইডবারের **All Materials** অপশন থেকে সব ক্লাসের PDF একসাথে পাওয়া যাবে। 📄",
    keywords: ["pdf", "পিডিএফ", "ম্যাটেরিয়াল", "material", "নোট", "note"],
  },
  {
    id: "routine",
    icon: <RefreshCw className="h-3.5 w-3.5" />,
    question: "ক্লাস রুটিন কোথায় পাব?",
    answer:
      "প্রোফাইল পেজ বা সাইডবারের **Class Routine** অপশন থেকে দেখা যাবে। 📅",
    keywords: ["রুটিন", "routine", "সময়সূচি", "schedule", "ক্লাস রুটিন"],
  },
  {
    id: "exam",
    icon: <KeyRound className="h-3.5 w-3.5" />,
    question: "এক্সাম কিভাবে দিব?",
    answer:
      "এক্সাম পেজে সব এক্সামের লিস্ট দেখা যাবে, এক্সাম ওপেন করে শর্তাবলী **Accept** করুন, তারপর এক্সাম শুরু করুন। 📝",
    keywords: ["এক্সাম", "exam", "পরীক্ষা", "test", "কুইজ", "quiz"],
  },
  {
    id: "exam-rules",
    icon: <ShieldQuestion className="h-3.5 w-3.5" />,
    question: "এক্সামের শর্তাবলী কী কী?",
    answer:
      "**এক্সামের শর্তাবলী:**\n\n• এক্সাম একবার ওপেন করলে অবশ্যই **Submit** করতে হবে\n• এক্সাম চলাকালীন বের হওয়া যাবে না\n• ট্যাব সুইচ বা যেকোনো ধরনের জালিয়াতি সম্পূর্ণ **নিষিদ্ধ** ⚠️",
    keywords: ["শর্ত", "rules", "নিয়ম", "শর্তাবলী", "জালিয়াতি", "ট্যাব"],
  },
  {
    id: "result",
    icon: <ClipboardList className="h-3.5 w-3.5" />,
    question: "রেজাল্ট ও র‍্যাংকিং কিভাবে দেখব?",
    answer:
      "এক্সাম সাবমিট করলেই নিজের রেজাল্ট দেখা যাবে। এক্সামের সময় শেষ হলে সবার **র‍্যাংকিং** পাবলিশ হবে, এক্সাম পেজ থেকে দেখা যাবে। 🏆",
    keywords: ["রেজাল্ট", "result", "র‍্যাংকিং", "ranking", "নম্বর", "marks", "ফলাফল"],
  },
];
...
// Gemini-style smooth, swift upward fade-in presentation component
function GeminiStreamText({ text, triggerKey }: { text: string; triggerKey?: number }) {
  return (
    <div 
      key={triggerKey}
      className="animate-gemini-reveal"
      style={{
        animation: "geminiReveal 0.4s cubic-bezier(0.1, 0.9, 0.2, 1) both"
      }}
    >
...
export function FloatingButtons() {
  ...
  const [waWelcomeShown, setWaWelcomeShown] = useState(false);
  ...
  }, [waHistory, waTyping, waWelcomeShown]);

  // Show typing dots first, then reveal the welcome message with animation
  useEffect(() => {
    if (whatsappOpen) {
      setWaWelcomeShown(false);
      setWaTyping(true);
      const delay = Math.min(400 + WELCOME_TEXT.length * 0.4, 1200);
      const timer = setTimeout(() => {
        setWaTyping(false);
        setWaWelcomeKey((k) => k + 1);
        setWaWelcomeShown(true);
      }, delay);
  ...
  const respondWithFaq = (faq: FAQ) => {
    ...
    setIsTyping(true);
    const delay = Math.min(300 + faq.answer.length * 0.4, 1200);
    setTimeout(() => {
      setIsTyping(false);
      pushMessage({
        role: "bot",
  ...
  const handleSend = () => {
    ...
    setIsTyping(true);
    const replyDelay = (content: string) => Math.min(400 + content.length * 0.4, 1200);
    setTimeout(() => {
      setIsTyping(false);
      if (matched) {
        pushMessage({
          ...
          >
            {waTyping && (
              <div className="flex justify-start">
                <div className="bg-card border border-border rounded-lg rounded-tl-none px-3 py-2 shadow-sm">
                  <TypingDots />
                </div>
              </div>
            )}
