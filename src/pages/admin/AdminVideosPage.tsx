...
import { Plus, Edit, Trash2, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Search, Film } from "lucide-react";
        ...
        {paginatedVideos.map((v, idx) => {
          ...
          return (
            <div key={v.id} className="p-3 bg-card rounded-xl border border-border flex gap-3 items-center hover:border-primary/20 transition-colors">
              ...
              {v.thumbnail ? (
                <img src={v.thumbnail} alt="" className="w-24 sm:w-28 aspect-video rounded-lg object-cover flex-shrink-0" />
              ) : (
                <div className="w-24 sm:w-28 aspect-video bg-muted rounded-lg flex-shrink-0 flex items-center justify-center">
